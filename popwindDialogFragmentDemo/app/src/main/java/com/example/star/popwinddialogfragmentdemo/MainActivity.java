        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mBottomFragment==null){
                    mBottomFragment=BottomFragment.newInstance("info1","info2");
                }
                mBottomFragment.show(getFragmentManager(),"mBottomFragment");

//                if(mContactsDialog==null){
//                    mContactsDialog=new ContactsDialog();
//                }
//                mContactsDialog.show(getSupportFragmentManager(),"mContactsDialog");
            }
        });
